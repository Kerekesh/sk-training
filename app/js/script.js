...
//     stringNums = digit.toString();
//     let res = 0;
//     for (let i = 0; i < stringNums.length; i++) {
//         res += parseInt(stringNums[i]);
//     }
//     return res;
// }
...
// let numbers = [5,65,54,-85,-45,1,-25,4];

// let isPositive = (num) => (num > 0 ? true : false);

// function createPositiveArr(array) {
//     let positiveNumbers = array.filter((item, i, array) => isPositive(item));
//     return positiveNumbers;
// }

// console.log(createPositiveArr(numbers));
